...
/***/ "./src/element/musicBtn.ts":
/*!*********************************!*\
  !*** ./src/element/musicBtn.ts ***!
  \*********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"MusicBtn\": () => (/* binding */ MusicBtn)\n/* harmony export */ });\n/* harmony import */ var _gameconfig__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../gameconfig */ \"./src/gameconfig.ts\");\nvar __extends = (undefined && undefined.__extends) || (function () {\n    var extendStatics = function (d, b) {\n        extendStatics = Object.setPrototypeOf ||\n            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||\n            function (d, b) { for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p]; };\n        return extendStatics(d, b);\n    };\n    return function (d, b) {\n        if (typeof b !== \"function\" && b !== null)\n            throw new TypeError(\"Class extends value \" + String(b) + \" is not a constructor or null\");\n        extendStatics(d, b);\n        function __() { this.constructor = d; }\n        d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());\n    };\n})();\n\nvar MusicBtn = /** @class */ (function (_super) {\n    __extends(MusicBtn, _super);\n    function MusicBtn() {\n        var _this = _super.call(this) || this;\n        _this.texture = FYGE.Texture.fromUrl(_gameconfig__WEBPACK_IMPORTED_MODULE_0__.musicPic);\n        _this.x = 680;\n        _this.y = 20;\n        _this.width = 40;\n        _this.height = 40;\n        var shp = new FYGE.Graphics();\n        shp.x = 0;\n        shp.y = 0;\n        shp.beginFill(0xff0000, 1);\n        shp.drawCircle(680, 20, 50);\n        shp.endFill();\n        _this.addChild(shp);\n        return _this;\n    }\n    return MusicBtn;\n}(FYGE.Sprite));\n\n\n\n//# sourceURL=webpack:///./src/element/musicBtn.ts?");
